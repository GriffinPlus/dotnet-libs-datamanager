...
partial class ExpectedDataValue<T>
{
	...
	public sealed class ReceivedUntypedChangedEventItem(
		string                           eventName,
		object                           sender,
		UntypedDataValueChangedEventArgs eventArgs,
		SynchronizationContext           synchronizationContext)
	{
		public readonly string                           EventName              = eventName;
		public readonly object                           Sender                 = sender;
		public readonly UntypedDataValueChangedEventArgs EventArgs              = eventArgs;
