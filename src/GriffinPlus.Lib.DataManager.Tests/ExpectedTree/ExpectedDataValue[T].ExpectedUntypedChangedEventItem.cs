...
partial class ExpectedDataValue<T>
{
	...
	public sealed class ExpectedUntypedChangedEventItem(
		string                                   eventName,
		object                                   sender,
		ExpectedUntypedDataValueChangedEventArgs eventArgs)
	{
		public readonly string                                   EventName = eventName;
		public readonly object                                   Sender    = sender;
		public readonly ExpectedUntypedDataValueChangedEventArgs EventArgs = eventArgs;
	}
}
