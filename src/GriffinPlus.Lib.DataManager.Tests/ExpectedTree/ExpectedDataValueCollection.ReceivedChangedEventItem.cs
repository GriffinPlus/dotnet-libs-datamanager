...
partial class ExpectedDataValueCollection
{
	...
	public sealed class ReceivedChangedEventItem(
		string                              eventName,
		object                              sender,
		DataValueCollectionChangedEventArgs eventArgs,
		SynchronizationContext              synchronizationContext)
	{
		public readonly string                              EventName              = eventName;
		public readonly object                              Sender                 = sender;
		public readonly DataValueCollectionChangedEventArgs EventArgs              = eventArgs;
