		...
		add
		{
			lock (RootNode.DataTreeManager.Sync)
			{
				...
				EventManager<DataEventArgs<T>>.RegisterEventHandler(
					...
					ChangedEventName,
					value,
					SynchronizationContext.Current ?? RootNode.DataTreeManager.DataTreeManagerHost.SynchronizationContext,
					true,
					true,
					this,
		...
		add
		{
			lock (RootNode.DataTreeManager.Sync)
			{
				...
				EventManager<DataEventArgs<T>>.RegisterEventHandler(
					...
					ChangedEventName,
					value,
					RootNode.DataTreeManager.DataTreeManagerHost.SynchronizationContext,
					true,
					true,
					this,
					new DataEventArgs<T>(this, DataChangedFlags.All | DataChangedFlags.InitialUpdate));
