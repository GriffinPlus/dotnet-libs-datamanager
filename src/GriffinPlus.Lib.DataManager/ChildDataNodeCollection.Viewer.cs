...
sealed partial class ChildDataNodeCollection
{
	...
	internal void ViewerRequestItems(RequestViewerDataNodesCallback callback, object state = null)
	{
		lock (mNode.DataTreeManager.Sync)
		{
			...
			DataNode[] nodes = [.. mBuffer];
			synchronizationContext.Post(_ => callback(ViewerWrapper, nodes, state), null);
		}
	}
	...
	/// <param name="callback">Callback that will receive the data nodes that are currently in the collection.</param>
	/// <param name="state">Some context object to pass to the <paramref name="callback"/> method.</param>
	internal void ViewerRequestItemsAsync(RequestViewerDataNodesCallback callback, object state = null)
	{
		lock (mNode.DataTreeManager.Sync)
		{
