...
/// <summary>
/// A snapshot of a <see cref="IUntypedDataValue"/>.
/// </summary>
public struct UntypedDataValueSnapshot
{
	#region Construction

	/// <summary>
	/// Initializes a new instance of the <see cref="UntypedDataValueSnapshot"/> class assuming nothing has changed
	...
	internal UntypedDataValueSnapshot(IUntypedDataValueInternal dataValue)
	{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="UntypedDataValueSnapshot"/> class copying another instance.
	/// </summary>
	/// <param name="other">Event arguments to copy.</param>
	internal UntypedDataValueSnapshot(UntypedDataValueSnapshot other)
	{
